...
- [ ] **Document usage** – Update `planning/twelve-column-grid-task-list.md` and design guidelines to point developers at the new `LayoutContainer` grid API, clarifying when to use span helpers versus stacking multiple grid hosts.
