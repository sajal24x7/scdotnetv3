...
export async function GET(context) {
  const [bookshelf, filmshelf, tvshelf, gameshelf] = await Promise.all([
    getCollection('bookshelf', publicationFilter('rss', 'bookshelf')),
    getCollection('filmshelf', publicationFilter('rss', 'filmshelf')),
    getCollection('tvshelf', publicationFilter('rss', 'tvshelf')),
    getCollection('gameshelf', publicationFilter('rss', 'gameshelf')),
  ]);
