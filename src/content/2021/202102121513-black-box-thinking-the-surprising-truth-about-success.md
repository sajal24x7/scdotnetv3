...
tags:
  - book-reviews
pubDate: 2021-02-12T15:13:38.000Z
updatedDate: 2024-12-24T11:08:03.000Z
image: /images/2021/02/Screenshot-2021-02-12-at-8.41.31-PM.png
...
Learning from mistakes can be done under two conditions, or environments:
  ...
  1. Under practice conditions, when the aim is to learn from mistakes, push the boundaries.
  2. Under real world conditions, when the tendency is there to avoid mistakes.
...
Because all of us think of ourselves as rational and intelligent. And when evidence comes up which shows that the view we held was wrong, we have two options:
  ...
  1. To pause and accept that we were wrong. The issue with this approach is that it is threatening. It forces us to acknowledge we might be wrong about things on which we have staked a great deal.
  2. The second option is to simply deny the evidence. We reframe the evidence, filter it, say it did not happen.

This [**cognitive dissonance**](https://en.wikipedia.org/wiki/Cognitive_dissonance) also becomes important in cases where we have made an effort to be a part of a group for example. Even if the group is bad, we would feel motivated to ignore everything, apply cognitive filters. Because our ego is involved. Similar example would be when you purchase a gadget, a costly gadget and it fails. You cannot say that it was a bad gadget. You purchased it. Your ego is staked on the decision.
...
The desire for perfectionism rests upon two fallacies:
  ...
  1. A miscalculation that you can create the perfect thing, sitting at home.
  2. Fear of failure. Basically pre-empting the closed loop.So worried about messing up that you do not enter the arena.
...
These epiphanies happen in two sorts of environments:
  ...
  1. When we are switching off. We have to take a step back for the associative state to emerge.
  2. When we are being sparked by the dissent of others, i.e. when we have to respond to challenges and critiques.
...
In a pre-mortem technique, at the off-set the leader tells the group that the project is dead. Now tell us why it has died. Similar to [Ali](https://aliabdaal.com)'s [video](https://youtu.be/0rkRC728rIU) where he talks about a goal, and also lists out the reasons why he might not be able to complete the goal.  
