...
created: 2025-01-28T19:51:45
updated: 2025-01-28T19:51:45
category: blog
tags: ["blog", "AI"]
...
[DeepSek’s models led to drop in valuations of a bunch of tech companies](https://daringfireball.net/linked/2025/01/27/nvidia-deepseek-haircut)

I read a bunch of these posts and was going to write about it, but then [I wrote about messy households instead](__GHOST_URL__/blog/what-a-mess/).

* * *

My [thoughts](__GHOST_URL__/essays/thoughts-on-ai/) on LLMs have not changed that much in the past months. There is no moat. Hence this week’s loss in valuations makes sense. These technologies will become more efficient, more commonplace and more useful. Companies that have the data already or control over the devices users use will have an advantage. But in the end, for a common person, these will be commodities.

There was a post from [Seth about Trusting AI](https://feeds.feedblitz.com/~/911457431/0/sethsblog~Trusting-AI/) this week that talked about this a bit. About the things you can trust an AI with and not. I believe we will get used to it as the technology reaches its zenith.
...
From [Ignore the Grifters - AI Isn't Going to Kill the Software Industry](https://www.dustinewers.com/ignore-the-grifters/)
