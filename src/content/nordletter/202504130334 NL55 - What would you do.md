...
![](https://storage.sajalchoudhary.net/images/2025/04/IMG_0878.jpeg)

* * *

While I waited for the library to open, saw a bunch of people waiting for the library to open as well. I found it funny\!

![](https://storage.sajalchoudhary.net/images/2025/04/IMG_0911.jpeg)

* * *

## /five things to share

### 1\. [The AI Race Has Gotten Crowded—and China Is Closing In on the US](https://www.wired.com/story/stanford-study-global-artificial-intelligence-index/)

> OpenAI and Google are still neck and neck in the race to build bleeding-edge AI, the report shows. But several other companies are closing in. In the US, the fiercest competition comes from [Meta’s](https://www.wired.com/tag/meta/) open weight Llama models; [Anthropic, a company](https://www.wired.com/story/anthropic-world-first-hybrid-reasoning-ai-model/) founded by former OpenAI employees; and Elon Musk’s [xAI](https://www.wired.com/story/xai-x-acquisition-deal/).
...
### 2\. [Meta got caught gaming AI benchmarks](https://www.theverge.com/meta/645012/meta-llama-4-maverick-benchmarks-gaming)
...
Also, file this as something not expected from Meta. [Instagram might finally release an iPad app](https://www.theverge.com/news/645625/instagram-ipad-app-tiktok). A finally if there ever was one.

### 3\. [Get ready for the Love, Death, and Robot’s fourth volume](https://www.theverge.com/news/645329/netflix-love-death-and-robots-season-4-trailer-release-date)

I love this series. I have watched each season till date, but [I'm not subscribed to Netflix anymore](__GHOST_URL__/blog/the-things-we-dont-need/), so maybe I will resubscribe just for this? Also, [John Siracusa has recommended some episodes](https://hypercritical.co/2025/04/10/love-death-robots).

> If you’ve read all this and still can’t tell which are the “safest” episodes for those who want to avoid gore, sex, and violence, I’d recommend [Three Robots](https://www.netflix.com/watch/80223967?trackId=14277283) \(S1E2\), [Zima Blue](https://www.netflix.com/watch/80223962) \(S1E14\), [Three Robots: Exit Strategies](https://www.netflix.com/watch/81424941) \(S3E1\), and [The Very Pulse of the Machine](https://www.netflix.com/watch/81424935) \(S3E3\). But remember, none of these episodes are really suitable for children.

### 4\. [A new generation of AIs: Claude 3.7 and Grok 3](https://www.oneusefulthing.org/p/a-new-generation-of-ais-claude-37)
...
### 5\. [CaMeL offers a promising new direction for mitigating prompt injection attacks](https://simonwillison.net/2025/Apr/11/camel/#atom-everything)
...
This week I wrote about voting, the value of organizing, two things about AI and about wanting to create things: moving my website and maybe an app. Enjoy\!
  ...
  1. [I voted for the first time in Finland](__GHOST_URL__/blog/i-voted-for-the-first-time-in-finland/)
  2. [Organizing the things in our life](__GHOST_URL__/blog/we-must-organize-the-things-in-our-life/)
  3. [I want to share little ephemeral messages with my family](__GHOST_URL__/blog/i-want-to-share-little-ephemeral-messages-with-my-family/)
  4. [Everything you type in your iPhone could be used to train a digital you](__GHOST_URL__/blog/everything-you-type-in-your-iphone-could-be-used-to-train-a-digital-you/)
  5. [Moving my home on the web](__GHOST_URL__/blog/moving-my-home-on-the-web/)
  6. [Just because you can do something does not mean you should](__GHOST_URL__/blog/just-because-you-can-do-something-does-not-mean-you-should/)
