...
I wrote earlier about [maybe posting daily](__GHOST_URL__/blog/how-to-blog/). I have had that constant itch to have a link-blog. To just share things I found on the web. I partly scratch that itch by posting those things as part of every [nordletter](__GHOST_URL__/nordletter/). But nord-letter comes out once a week, and there is an immediacy effect to some of these news things.

This is what Twitter type thing is for, I suppose. But I don't want to just post anything on the socials. Everything I create should ideally be [here](__GHOST_URL__/nordletter/).
