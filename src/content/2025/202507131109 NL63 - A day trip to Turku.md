...
We went to [Turku](https://www.turku.fi/en) last week. It was not something that we were supposed to do, but ended up doing *anyway* because it was *sunny* in the morning. It was supposed to be, so not a surprise in any way. But around 5-6 there were chances that we would get rain. That was why the trip was not a done thing.
...
Turku reminded me of Paris, of people sitting on benches around the [Seine](https://en.wikipedia.org/wiki/Seine). They would wave at us as we went away on our boat. There were no waving people here, but there were people on both sides of the [Aura river](https://en.wikipedia.org/wiki/Aura_River_(Finland)). It's not that people don't sit on benches around rivers in Helsinki. They do, I have been one of those people on Töölö. But Töölö is a lake. And a lake is not a river.
...
![The view of the river at Turku](https://storage.sajalchoudhary.net/images/2025/07/nl63-1.jpeg)
...
![On the bridge](https://storage.sajalchoudhary.net/images/2025/07/nl63-2.jpeg)

After leaving the bridge, we had ice cream. I had my favourite mango, Prerna had strawberry, and Savya had both.

Then we walked to the [cathedral](https://en.wikipedia.org/wiki/Turku_Cathedral) which was around a kilometre from where we were and so we walked and walked and walked. 

![A nest sort of a thing](https://storage.sajalchoudhary.net/images/2025/07/nl63-3.jpeg)

![At the shores of the river](https://storage.sajalchoudhary.net/images/2025/07/nl63-4.jpeg)

![Another bridge](https://storage.sajalchoudhary.net/images/2025/07/nl63-5.jpeg)

![The cathedral in the background](https://storage.sajalchoudhary.net/images/2025/07/nl63-1.jpeg)

Finally, we reached the [cathedral](https://en.wikipedia.org/wiki/Turku_Cathedral). 

![Turku cathedral](https://storage.sajalchoudhary.net/images/2025/07/nl63-7.jpeg)

[Turu Cathedral](https://en.wikipedia.org/wiki/Turku_Cathedral) is the only medieval basilica in Finland. It is the seat of the Lutheran Archbishop of Finland. Whenever I am at places like these, I always wonder how people would have interacted with and used this building in the olden times, when this was more than a monument. I try to imagine their lives. How it would feel standing in this building, praying in it.

I did a similar thing when I was in Bihar and [saw the Ashok Pillars and museum](https://sajalchoudhary.net/blog/visiting-the-ashokan-pillar-in-vaishali/). I was wondering how people would have lived and how this would have looked in Ashoka's time. There was a helpful little illustration which showed you from the view of the huts you could see the stupa in a distance.
...
![At the gates of the Turku cathedral](https://storage.sajalchoudhary.net/images/2025/07/nl63-8.jpeg)
...
![Inside the Turku cathedral](https://storage.sajalchoudhary.net/images/2025/07/nl63-9.jpeg)

![The frescoes of the Turku cathedral](https://storage.sajalchoudhary.net/images/2025/07/nl63-10.jpeg)
...
![Coat of arms](https://storage.sajalchoudhary.net/images/2025/07/nl63-11.jpeg)
...
### 1. [Tasks and projects](https://feeds.feedblitz.com/~/921834878/0/sethsblog~Tasks-and-projects/)
...
### 2. [Reflections on OpenAI](https://calv.info/openai-reflections#footnote-fnref-3)
...
### 3. [The Sputnik vs. Deep Seek Moment: The Answers - Marginal REVOLUTION](https://feeds.feedblitz.com/~/921787157/0/marginalrevolution~The-Sputnik-vs-Deep-Seek-Moment-The-Answers.html)

> Zero sum thinking fuels support for trade protection: if other countries gain, we must be losing. It drives opposition to immigration: if immigrants benefit, natives must suffer. And it even helps explain hostility toward universities and the desire to cut science funding. _For the zero-sum thinker, there’s no such thing as a public good or even a shared national interest—only “us” versus “them.”_ In this framework, funding top universities isn’t investing in cancer research; it’s enriching elites at everyone else’s expense. Any claim to broader benefit is seen as a smokescreen for redistributing status, power, and money to “them.”
...
### 4. [Google’s curated AI ‘notebooks’ talk you through topics from parenting to Shakespeare](https://www.theverge.com/news/706854/google-notebooklm-featured-notebook-ai-topics)

> The featured notebooks include original text from the source material, whether it’s a book, play, newsletter, or online article. NotebookLM automatically summarizes this information and comes preloaded with notes about the topics discussed in the source material. You can also interact with NotebookLM’s AI chatbot to ask questions about the information, as well as listen to [pregenerated Audio Overviews](https://www.theverge.com/news/657785/google-audio-overviews-ai-podcasts-50-languages), the podcast-like discussions featuring AI “hosts.”

The NotebookLM product famously came from a Googler’s [20 % time](https://www.businessinsider.com/google-20-percent-time-policy-2015-4). I have not used this product, but I have found myself spending more time with voice (speech-to-text and audiobooks ). 
...
### 5. [Uber’s Robotaxi Is No Quick Delivery](https://om.co/2025/07/17/ubers-robotaxi-is-no-quick-delivery/)
