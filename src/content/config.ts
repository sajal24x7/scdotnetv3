...
const postsCollection = defineCollection({
  ...
  schema: z.object({
    ...
    category: z.enum(['evergreen', 'blog', 'micro', 'photo', 'nordletter', 'stories', 'poems', 'books', 'now', 'til']),
...
const notesCollection = defineCollection({
  ...
  schema: z.object({
    ...
    pubDate: dateSchema,
    updatedDate: dateSchema.optional(),
    category: z.enum(['evergreen', 'blog', 'micro', 'photo', 'nordletter', 'stories', 'poems', 'books', 'til']).optional(),
    tags: z.array(z.string()).optional(),
    image: z.string().optional(),
